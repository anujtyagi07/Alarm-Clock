Description: This project is a repository for an Alarm Clock developed using Vanilla JavaScript, HTML, and CSS. It aims to provide a soothing user experience with powerful features and a clean interface.
